  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden group">
        ...
        {/* Availability Badge */}
        <span className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold ${product.availability === "In Stock" ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}>
...
// import { CartContext } from '../context/CartContext'; // Import the global cart context
...
//     } else {
//       toast.warning("Item is already in wishlist!", { position: "top-right", autoClose: 2000 });
//     }
//   };
...
//   return (
//     <div 
//       className=" bg-gradient-to-b from-teal-900 to-black shadow-md rounded-md p-4 w-full font-poppins cursor-pointer"
//       data-aos="fade-up"
//       data-aos-delay="100"
//     >
...
//         />
//         <div className=" absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
//           <button
//             onClick={handleAddToWishlist}
//             className="flex items-center gap-2 bg-teal-600 text-white px-2 py-2 rounded-full hover:bg-teal-800 transition-transform duration-300 transform hover:scale-105"
//           >
//             <FaHeart />
//           </button>
//           <button
...
//       <div className='p-5 w-auto h-auto'>

//       <h2 className="text-xl font-bold text-gray-200 mt-4">{product.name}</h2>
//       <p className="text-lg text-red-500 font-semibold mt-2">${product.price}</p>
...
// const ProductCarousel = () => {
//   return (
//     <div className="w-full p-10  bg-gradient-to-b from-teal-900 to-black font-poppins pb-20">
//       <ToastContainer position="top-right" autoClose={2000} />
      
//       <h4 
//         className='text-center text-white justify-center uppercase mb-10'
//         data-aos="fade-down"
//         data-aos-delay="50"
//       >
//         Products
...
//   // Function to add product to cart (using global context)
//   const handleAddToCart = () => {
//     addToCart(product);
//     toast.success(`${product.name} added to cart!`, { position: "top-right", autoClose: 2000 });
//   };
...
//   return (
//     <div className="bg-gray-200 shadow-md rounded-md p-4 w-full font-poppins cursor-pointer">
//       <div className="relative group">
//         <img
//           src={product.image}
//           alt={product.name}
...
// const ProductCarousel = () => {
//   return (
//     <div className="w-full p-10 bg-black font-poppins pb-20">
//       <ToastContainer position="top-right" autoClose={2000} />
//       <h4 className='  text-center text-white justify-center uppercase mb-10'>Products</h4>
