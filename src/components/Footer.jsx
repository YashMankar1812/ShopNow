  ...
  return (
    <footer className="bg-gray-900 py-8 sm:py-12 font-poppins text-white">
      ...
      <div className="text-center mb-8 px-4">
        <h1 className="text-2xl sm:text-3xl md:text-5xl pb-3 text-gray-400">
          ShopNow
        </h1>
      ...
      {/* Main Grid */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <ul className="space-y-2">
            {quickLinks.map((item) => (
              <li key={item.name}>
                <Link
                  to={item.path}
                  className="text-sm text-gray-400 hover:text-teal-300 transition hover:underline"
                >
                  {item.name}
                </Link>
              </li>
        ...
        <div>
          ...
          <form onSubmit={handleSubscribe} className="flex gap-2">
            <input
              ...
              className="w-full p-2 rounded-md bg-gray-800 text-gray-300 focus:ring-2 focus:ring-teal-500 outline-none"
            />
            <button
              type="submit"
              className="bg-teal-600 hover:bg-teal-700 px-4 rounded-md flex items-center gap-2"
            >
              <FaPaperPlane />
            </button>
          </form>
      ...
      <div className="text-center text-gray-400 mt-10 text-sm px-4">
        ...
        <br />
        Developed by <span className="text-white">Yash Mankar</span>
      </div>
    </footer>
  );
};
