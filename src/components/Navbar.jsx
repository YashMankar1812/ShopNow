...
//           <ul className={`lg:flex space-x-6 text-gray-700 cursor-pointer ${isMenuOpen ? "block" : "hidden"} lg:block`}>
//             <li>
//               <NavLink to="/" className="hover:text-black cursor-pointer font-semibold" activeClassName="text-black">
//               Home
//               </NavLink>
//             </li>
//             <li
...
//               className="relative"
//             >
//               <NavLink to="/shop" className="font-semibold hover:text-black" activeClassName="text-black">
//                 Shop
//               </NavLink>
//               <ul
//                 className={`absolute bg-white shadow-md c p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//               className="relative"
//             >
//               <NavLink to="/category" className="font-semibold hover:text-black" activeClassName="text-black">
//                 Categories
//               </NavLink>
//               <ul
//                 className={`absolute bg-white shadow-md w-40 p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//                 </li>
//                 <li>
//                   <NavLink to="/category/home" className="hover:text-black block">
//                     Home & Living
//                   </NavLink>
//                 </li>
//                 <li>
...
//               className="relative"
//             >
//               <NavLink to="/sales" className="font-semibold hover:text-black" activeClassName="text-black">
//                 Sales
//               </NavLink>
//               <ul
//                 className={`absolute bg-white shadow-md w-40 p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//             </li>
//             <li>
//               <NavLink to="/contact" className="font-semibold hover:text-black" activeClassName="text-black">
//                 Contact
//               </NavLink>
//             </li>
...
//               <CiSearch className="stroke-1 text-lg" />
//             </button>

//             {/* Show search input and close button when isSearchOpen is true */}
//             {isSearchOpen && (
...
//             <NavLink  className="bg-orange-300  p-2 m-2 rounded-full font-semibold " activeClassName="text-black">
...
//         <ul className={`lg:flex space-x-6 text-gray-700 cursor-pointer ${isMenuOpen ? "block" : "hidden"} lg:block`}>
//           <li>
//             <NavLink to="/" className="hover:text-black cursor-pointer" activeClassName="text-black">
//               Home
//             </NavLink>
//           </li>
//           <li
...
//             className="relative"
//           >
//             <NavLink to="/shop" className="hover:text-black" activeClassName="text-black">
//               Shop
//             </NavLink>
//             <ul
//               className={`absolute bg-white shadow-md c p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//             className="relative"
//           >
//             <NavLink to="/category" className="hover:text-black" activeClassName="text-black">
//               Categories
//             </NavLink>
//             <ul
//               className={`absolute bg-white shadow-md w-40 p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//             className="relative"
//           >
//             <NavLink to="/sales" className="hover:text-black" activeClassName="text-black">
//               Sales
//             </NavLink>
//             <ul
//               className={`absolute bg-white shadow-md w-40 p-3 rounded space-y-2 transition-all duration-300 ease-in-out ${
...
//           </li>
//           <li>
//             <NavLink to="/contact" className="hover:text-black" activeClassName="text-black">
//               Contact
//             </NavLink>
//           </li>
//         </ul>
