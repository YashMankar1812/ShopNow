...
const ElectronicsPage = () => {
  ...
  const handleAddToCart = (product) => {
    ...
    toast.success(`${qty > 1 ? `${qty} × ` : ''}${product.name} added to cart`, {
      position: "top-right", // react-hot-toast uses 'top-right', 'bottom-left', etc.
      duration: 3000,       // Duration in milliseconds
      // No direct equivalents for hideProgressBar, closeOnClick, pauseOnHover, draggable, theme in react-hot-toast's toast.success options.
      // You can customize global Toaster props or use custom toasts for more control.
    });
  ...
  const handleShopNewArrivals = () => {
    toast('Redirecting to new arrivals!', {
      icon: '🚀',
      position: 'top-center',
      duration: 2000,
    });
  ...
  const handleCategoryClick = (categoryName) => {
    toast.success(`Browse ${categoryName}!`, {
      icon: '🔍',
  ...
  const handleViewAllProducts = () => {
    toast.info('Loading all products...', {
      icon: '📦',
    ...
    <div className="min-h-screen bg-gray-50 mt-10 font-poppins">
      ...
      <div className="relative bg-black h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <button 
            onClick={handleShopNewArrivals} // Added onClick
            className="bg-white text-gray-900 px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition flex items-center mx-auto"
          >
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            ...
            <button 
              onClick={handleViewAllProducts} // Added onClick
