...
const BeautyPage = () => {
  // Product categories with professional icons
  ...
  // Featured products with realistic data
  ...
  // Beauty tips with realistic content
  const beautyTips = [
    {
      id: 1,
            ...
            {featuredProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition duration-300 group">
                <div className="relative">
                  ...
                  <button className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black text-white px-6 py-2 rounded-full opacity-0 group-hover:opacity-100 transition duration-300 flex items-center">
