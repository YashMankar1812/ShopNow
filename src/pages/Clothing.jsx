...
const Clothing = () => {
  const products = [
    ...
    },
    {
      ...
      price: "$39.99",
      image: "https://images.unsplash.com/photo-1582552802283-e18e7e163a0d", // Added a placeholder image
    },
    {
      id: 3,
    ...
    },
    {
      ...
      name: "Men's Hoodie",
      price: "44.99",
      image: "https://m.media-amazon.com/images/I/41oxHlqVLXL.jpg",
    },
    {
      id: 6,
  ...
  const handleBuyNowClick = (productName) => {
  ...
  // Function to handle category click (for demonstration)
  const handleCategoryClick = (categoryName) => {
    toast(`Exploring ${categoryName}...`, {
      icon: '🛍️', // Custom icon
      duration: 2000,
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 mt-20 font-poppins ">
      ...
      <header className="text-center mb-10">
        <h3 className="text-5xl font-extrabold text-gray-400">
          Clothing Collection
        </h3>
        <p className="text-lg text-gray-600 mt-3">
          Upgrade your wardrobe with the latest fashion trends and premium
          outfits.
        </p>
      </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {[
            ...
            <div
              ...
              onClick={() => handleCategoryClick(category.name)} // Added onClick handler
            >
              <img
                src={category.img}
                alt={category.name}
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-5 text-center">
                ...
                <button
                  className="mt-4 bg-teal-600 text-white px-6 py-2 rounded-full font-medium hover:bg-teal-700 transition"
                  onClick={() => handleBuyNowClick(product.name)} // Added onClick handler
                >
                  Buy Now
                </button>
              </div>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-teal-500 to-teal-700 text-white rounded-lg">
        ...
        <p className="text-lg mt-2">
          Shop now and stay ahead in fashion trends.
        </p>
        <button
          className="mt-6 bg-white text-teal-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition"
          onClick={() => toast('Redirecting to full collection...', { icon: '✨' })} // Added onClick
        >
          Explore More
        </button>
      </section>
