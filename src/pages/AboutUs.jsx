...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-poppins px-4 sm:px-6 md:m-10">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-teal-600 to-teal-800 text-white py-12 md:py-20">
        <div className="absolute inset-0 bg-black opacity-20"></div>
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4" data-aos="fade-down">
            About ShopNow
          </h1>
          <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto" data-aos="fade-down" data-aos-delay="200">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-10 md:py-16">
        {/* Who We Are */}
        <section className="mb-12 md:mb-20" data-aos="fade-up">
          <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-12">
            <div className="w-full lg:w-1/2">
              <div className="p-4 sm:p-6 md:p-8">
                <div className="flex items-center mb-4 md:mb-6">
                  <div className="bg-teal-100 p-2 md:p-3 rounded-full mr-3 md:mr-4">
                    <FaStore className="text-teal-600 text-xl md:text-2xl" />
                  </div>
            ...
            <div className="w-full lg:w-1/2 mt-6 lg:mt-0">
              <img 
                ...
                className="rounded-lg md:rounded-xl shadow-md md:shadow-lg w-full h-auto object-cover"
                data-aos="zoom-in"
              />
            </div>
          </div>
        ...
        {/* Mission & Vision */}
        <section className="mb-12 md:mb-20 bg-white p-6 md:p-12 rounded-lg md:rounded-xl" data-aos="fade-up">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center justify-center bg-teal-100 p-2 md:p-3 rounded-full mb-3 md:mb-4">
              <FaGlobe className="text-teal-600 text-xl md:text-2xl" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3 md:mb-4">Our Mission & Vision</h2>
            <div className="w-16 md:w-24 h-0.5 md:h-1 bg-teal-600 mx-auto"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-lg" data-aos="fade-right">
              <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3 md:mb-4">Mission</h3>
            ...
            <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-lg" data-aos="fade-left">
              <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3 md:mb-4">Vision</h3>
              <p className="text-sm sm:text-base text-gray-700">
        ...
        <section className="mb-12 md:mb-20" data-aos="fade-up">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center justify-center bg-teal-100 p-2 md:p-3 rounded-full mb-3 md:mb-4">
              <FaCheckCircle className="text-teal-600 text-xl md:text-2xl" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3 md:mb-4">Our Core Values</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {coreValues.map((value, index) => (
              <div 
                key={index} 
                className="bg-white p-4 sm:p-6 md:p-8 rounded-lg md:rounded-xl shadow-sm md:shadow-md hover:shadow-md md:hover:shadow-lg transition-shadow duration-300 border-t-2 md:border-t-4 border-teal-600"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                <div className="bg-teal-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mb-4 md:mb-6 mx-auto">
                  {value.icon}
                </div>
                <h3 className="text-lg md:text-xl font-bold text-center text-gray-800 mb-2 md:mb-3">{value.title}</h3>
                <p className="text-xs sm:text-sm md:text-base text-gray-600 text-center">{value.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-12 md:mb-20" data-aos="fade-up">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center justify-center bg-teal-100 p-2 md:p-3 rounded-full mb-3 md:mb-4">
              <FaUsers className="text-teal-600 text-xl md:text-2xl" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3 md:mb-4">Leadership Team</h2>
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <div 
                key={index} 
                className="bg-white rounded-lg md:rounded-xl overflow-hidden shadow-md md:shadow-lg hover:shadow-lg md:hover:shadow-xl transition-shadow duration-300"
                data-aos="zoom-in"
                data-aos-delay={index * 100}
              >
                ...
                <div className="p-4 sm:p-6 text-center relative -mt-10 md:-mt-12">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto rounded-full border-2 md:border-4 border-white overflow-hidden relative shadow-sm md:shadow-md">
                    <img 
                      src={member.img} 
                      alt={member.name} 
                  ...
                  <h3 className="text-lg sm:text-xl md:text-xl font-bold mt-3 md:mt-4 text-gray-800">{member.name}</h3>
                  <p className="text-teal-600 font-medium mb-2 md:mb-3 text-sm md:text-base">{member.role}</p>
