...
const KidsWear = () => {
  ...
  const handleQuantityChange = (productId, value) => {
    const numValue = Math.max(1, Math.min(10, Number(value))); // Ensure quantity is between 1 and 10
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-poppins mt-20">
          ...
          <div className="flex flex-wrap gap-2">
            {ageGroups.map(age => (
              <button
                ...
                onClick={() => {
                  setAgeFilter(age);
                  toast.success(`Showing ${age} products!`, {
      ...
      {filteredProducts.length === 0 && (
        <div className="text-center py-12">
          ...
          <button 
            onClick={handleResetFilters} // Call the new handler
